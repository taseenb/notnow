...
void testApp::setup() {
    ...
    face_outline.setFillColor(ofColor(255,0,0));
...
void testApp::draw() {
    ...
    //rotatedTexture.draw(80, 60); // center in a 800x600 screen
    kinect.draw(80, 60);
    //kinect.draw(120, 60, 640, 480); // center in a 800x600 screen
    ofPopMatrix();
...
//    tracker.getImageFeature(ofxFaceTracker::JAW).draw();
